...
export default function ProductosFaldas() {
  const [categoriaActual] = useState({
    id: 5,
    nombre: 'Faldas de Enredo',
    descripcion: 'Faldas tradicionales tejidas con diseños vibrantes. Elaboradas con lana natural y tintes vegetales ancestrales',
  });
