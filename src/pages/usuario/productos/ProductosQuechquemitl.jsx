...
export default function ProductosQuechquemitl() {
  const [categoriaActual] = useState({
    id: 6,
    nombre: 'Quechquémitl',
    descripcion: 'Prenda tradicional ceremonial con bordado zapoteco. Tejida en telar de cintura con técnicas de brocado ancestral',
  });
